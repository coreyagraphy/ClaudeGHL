...
const RESEARCH_SCHEMA = {
  ...
  properties: {
    ...
    owner_first: { anyOf: [{ type: "string" }, { type: "null" }] },
    ...
    years_in_business: { anyOf: [{ type: "integer" }, { type: "null" }] },
    ...
    content_freshness_months: { anyOf: [{ type: "integer" }, { type: "null" }] },
    last_content_date: { anyOf: [{ type: "string" }, { type: "null" }] },
